...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] selection:bg-[#d4af37] selection:text-black overflow-x-hidden">
      ...
      <a
        href="https://wa.me/966548321927"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-50 bg-[#25D366] p-4 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 group"
      >
